...
if($_SESSION['loggedIn'] == true) 
{
	if($_SESSION['accType'] == "pracownik")
		header('Location: employee.php?orderby=dateModified&order=DESC');
	if($_SESSION['accType'] == "koordynator")
		header('Location: employee.php?orderby=dateModified&order=DESC');
	if($_SESSION['accType'] == "kierownik")
		header('Location: manager_new.php?orderby=dateModified&order=DESC');
	if($_SESSION['accType'] == "archiwum")
		header('Location: piwnica_new.php?orderby=dateModified&order=DESC');
	if($_SESSION['accType'] == "korespondencja")
		header('Location: index_a.php?orderby=dateModified&order=DESC');
