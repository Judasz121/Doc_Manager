		...
		<?PHP
			...
			<div class="doc item '; $p = $doc['progress'];
				...
				if (($doc['docSpace'] === "archiwum1" || $doc['docSpace'] === "archiwum2") && ($doc['progress'] === "P" || $doc['progress'] === "Z" || $doc['progress'] === "WP")){ echo '<a class="tooltip" href="#">
					<b>BŁĄD</b><span class="classic">Teczka nie moze być jednocześnie u pracownika i w archiwum <br><b>Teczka przypisana jest do <u>'.$doc['docSpace'].'</u></b></span></a>';
				} elseif ($doc['docSpace'] === "pracownik") { echo '<a class="tooltip" href="#">
					Wydano<span class="classic">Teczka jest u pracownika</span></a>';
				} elseif ($doc['docSpace'] === "archiwum1" || $doc['docSpace'] === "archiwum2"){ echo '<a class="tooltip" href="#">
					Archiwum<span class="classic">Teczka znajduje się w Archiwum 1 lub 2</span></a>';
				} elseif ($doc['docSpace'] === "") { echo '<a class="tooltip" href="#">
					(!)<span class="classic">Nie określono miejsca znajdowania się teczki<br><b>Należy odszukać teczkę</b></span></a>';
				} echo'
				</div>
				';
				if($doc['docSpace'] != "")
