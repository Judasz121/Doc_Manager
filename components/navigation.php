...
<font size="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jesteś zalogowany jako:&nbsp;<b><?php echo $_SESSION['login'].' '.$_SESSION['fullName'].'</b> | Typ konta:<b>'.$_SESSION['accType'];?></b></font><BR><BR><BR><BR>
	<div class="navButtons">
		...
		<?php if($_SESSION['accType'] == "admin" || $_SESSION['accType'] == "dyrektor" || $_SESSION['accType'] == "kierownik" || $_SESSION['accType'] == "pracownik" || $_SESSION['accType'] == "koordynator")
			echo'<a href="employee.php?orderby=dateModified&order=DESC" class="logout"><button class="button">'.$employee.'</button></a>';
		?>
		<?php if($_SESSION['accType'] == "admin" || $_SESSION['accType'] == "dyrektor" || $_SESSION['accType'] == "kierownik" || $_SESSION['accType'] == "korespondencja")
			echo'<a href="korekta.php?orderby=dateModified&order=DESC" class="logout"><button class="button">'.$korekta.'</button></a>';
		?>
		<br>
		...
		<?php if($_SESSION['accType'] == "admin" || $_SESSION['accType'] == "dyrektor" || $_SESSION['accType'] == "kierownik")
			echo'<a href="manager_new.php?orderby=dateModified&order=DESC" class="logout"><button class="button">'.$manager.'</button></a>';
		?>
		<?php if($_SESSION['accType'] == "admin" || $_SESSION['accType'] == "dyrektor" || $_SESSION['accType'] == "archiwum" )
		...
		<?php if($_SESSION['accType'] == "admin")
			echo'<a href="duplicate.php?orderby=dateModified&order=DESC" class="logout"><button class="button">'.$duplicate.'</button></a>';
		?>
		</div>
	<div class="navStats">
	<?php
