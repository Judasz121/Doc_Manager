		...
		<h1><?php echo $filtr. ' '. $manager;?></h1>
			...
			<div class="progress">
				...
				<select name="filterProgress" class="filter">
					...
					<option value="NP"<?php if($_POST['filterProgress'] == "NP") echo'selected '; ?>>NP</option>
					<option value="K"<?php if($_POST['filterProgress'] == "K") echo'selected '; ?>>K</option>
				</select>
			</div>
			<div class="asignedTo">
