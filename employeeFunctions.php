...
function BuildLimitQuery($limit, $filter)
{
    ...
    $sql = "SELECT COUNT(*) FROM documents WHERE workerAsigned='" . $_SESSION['login'] . "' ".$filter." AND progress != 'N' AND progress != 'W' AND progress != 'WP'";
...
function SaveChanges(array $documentIds, array $clientNum, array $name, array $surName, array $yearHired, array $dateWorkStart, array $dateWorkEnd, array $docType, array $docImportance, $docSpace, $docMMM, array $progress, array $asignedTo, array $comments, $saveSelected, bool $saveOnlySelected)
{
    global $conn;
