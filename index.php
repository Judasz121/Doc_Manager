<?php
	...
	while($user = $result -> fetch_assoc()){
		if($user['userName'] == $_SESSION['login'] && !( $user['accountType'] == "admin" || $user['accountType'] == "pracownik" || $user['accountType'] == "koordynator" || $user['accountType'] == "dyrektor" || $user['accountType'] == "archiwum" ))
			header('Location: login.php');
	}
  ...
  document.removeEventListener("copy", listener);
	...
	<form method="POST" class="">
		...
		<div class="wybor">
			...
			<label>
				<input type="radio" name="docSpace" value="archiwum1" />
				<span >1</span>
			</label>
			<label>
				<input type="radio" name="docSpace" value="archiwum2"> 
				<span>2</span>
			</label>
		</div>
		<div>
