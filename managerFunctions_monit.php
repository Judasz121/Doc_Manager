...
{
    $dateMinus90days = date('Y-m-d H:m:s', strtotime("-1 days"));
    $query = ' WHERE dateModified <= "'.$dateMinus90days.'"AND (progress LIKE "P" OR progress LIKE "Z") AND (docImportance LIKE "Zagr-N" OR docImportance LIKE "art.97 kpa")';
...
function SaveChanges(array $documentIds, array $clientNum, array $name, array $surName, array $yearHired, array $dateWorkStart, array $dateWorkEnd, array $docType, array $docImportance, array $docSpace, array $docMMM, array $progress, array $asignedTo, array $comments, $saveSelected, $deleteSelected, bool $saveOnlySelected)
{
    global $conn;
