<?php
	...
	require_once 'managerFunctions_monit_zagr.php';
	...
	if($dontSave == false && (isset($_POST['save']) || isset($_POST['saveOnlySelected']))) {
        ...
        $result = SaveChanges($_POST['clientNum'], $_POST['clientNum'],$_POST['name'],$_POST['surName'],$_POST['yearHired'],$_POST['dateWorkStart'],$_POST['dateWorkEnd'],$_POST['docType'],$_POST['docImportance'],$_POST['progress'],$_POST['asignedTo'],$_POST['comments'],$_POST['saveSelected'],$_POST['deleteSelected'], $saveOnlySelected);
        echo $result;
    }
...
<head>
	...
	<link rel="stylesheet" href="style_monit.css?v=1">
	<?php 
...
function copyToClip(str) {
  ...
  document.removeEventListener("copy", listener);
	...
	<?php  include 'components/navigation_manager.php';  ?>
	...
	<div class="pageselection"> ------------&nbsp;MONIT CZASU SPRAW&nbsp;<?php echo $monitKier;?>&nbsp;dni&nbsp;----&nbsp;&nbsp;&nbsp
...
?>
		...
		<!-----------------=================== FIRST ROW (COLUMN DESCRIPTION) ==============--------------------->
			<br><div align="right"><br>Monitor przekorczenia 180 dni dla Spraw Zagr-N<br> Wyrzut Spraw, które powiny być ponowione.<BR> Sprawy są przydzielone wg ostatniego pracownika</div>
		<div class="docList">
