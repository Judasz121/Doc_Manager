<?php
	...
	require_once 'managerFunctions_monit_kpa.php';
...
?>
		...
		<!-----------------=================== FIRST ROW (COLUMN DESCRIPTION) ==============--------------------->
			<br><div align="right"><br>Monitor przekorczenia 180 dni dla art.97 KPA.<br> Wyrzut Spraw, które powiny być ponowione.<BR> Sprawy są przydzielone wg ostatniego pracownika </div>
		<div class="docList">
